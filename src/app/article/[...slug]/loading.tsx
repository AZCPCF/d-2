  ...
  return (
    <main className="bg-gray-200/75 py-10 px-8 max-sm:px-4">
      <section className="grid-cols-12 grid gap-4 animate-pulse">
        {/* Main Content */}
        <div className="col-span-8 max-md:col-span-full rounded-xl grid grid-cols-1 bg-background relative shadow-md">
        ...
        <div className="col-span-4 max-md:col-span-full">
          <div className="sticky top-4 bg-background rounded-xl shadow-md p-4 space-y-4">
