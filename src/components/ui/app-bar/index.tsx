...
export default function AppBar() {
  ...
  return (
    <div className="fixed bottom-4 inset-x-4 z-20 max-md:block hidden">
      <div className="bg-secondary-main/70 backdrop-blur-md shadow-xl rounded-xl flex items-center justify-evenly gap-6 py-3 px-4 border border-white/10">
        {links.map((link, index) => (
          <NextLink
            ...
            className={cn(
              ...
              pathname === link.href
                ? "text-primary-main"
                : "text-white hover:text-secondary-600"
            )}
            label={
              <>
                <link.icon size={20} />
